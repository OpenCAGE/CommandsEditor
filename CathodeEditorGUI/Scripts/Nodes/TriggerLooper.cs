...
{
	[STNode("/")]
	public class TriggerLooper : STNode
	{
		...
		private float _m_delay;
		[STNodeProperty("delay", "delay")]
		public float m_delay
		{
			get { return _m_delay; }
			set { _m_delay = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.OutputOptions.Add("target", typeof(void), false);
