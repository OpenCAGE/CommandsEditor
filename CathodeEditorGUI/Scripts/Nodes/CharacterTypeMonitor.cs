...
{
	[STNode("/")]
	public class CharacterTypeMonitor : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "CharacterTypeMonitor";
			...
			this.OutputOptions.Add("all_despawned", typeof(void), false);
			this.OutputOptions.Add("AreAny", typeof(bool), false);
