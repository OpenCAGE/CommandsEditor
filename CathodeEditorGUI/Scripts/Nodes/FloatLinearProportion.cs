...
{
	[STNode("/")]
	public class FloatLinearProportion : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "FloatLinearProportion";
			
			this.InputOptions.Add("Initial_Value", typeof(float), false);
			this.InputOptions.Add("Target_Value", typeof(float), false);
