...
{
	[STNode("/")]
	public class IrawanToneMappingSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "IrawanToneMappingSettings";
			
			this.InputOptions.Add("target_device_luminance", typeof(float), false);
			this.InputOptions.Add("target_device_adaptation", typeof(float), false);
			this.InputOptions.Add("saccadic_time", typeof(float), false);
			this.InputOptions.Add("superbright_adaptation", typeof(float), false);
