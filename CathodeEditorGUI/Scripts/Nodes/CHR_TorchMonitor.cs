...
{
	[STNode("/")]
	public class CHR_TorchMonitor : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "CHR_TorchMonitor";
			
			this.InputOptions.Add("apply_start", typeof(void), false);
			this.InputOptions.Add("apply_stop", typeof(void), false);
			
			this.OutputOptions.Add("torch_on", typeof(void), false);
			this.OutputOptions.Add("torch_off", typeof(void), false);
			this.OutputOptions.Add("TorchOn", typeof(bool), false);
