...
{
	[STNode("/")]
	public class NavMeshBarrier : STNode
	{
		...
		private bool _m_opaque;
		[STNodeProperty("opaque", "opaque")]
		public bool m_opaque
		{
			get { return _m_opaque; }
			set { _m_opaque = value; this.Invalidate(); }
		}
		
		private string _m_allowed_character_classes_when_open;
		[STNodeProperty("allowed_character_classes_when_open", "allowed_character_classes_when_open")]
		public string m_allowed_character_classes_when_open
		{
			get { return _m_allowed_character_classes_when_open; }
			set { _m_allowed_character_classes_when_open = value; this.Invalidate(); }
		}
		
		private string _m_allowed_character_classes_when_closed;
		[STNodeProperty("allowed_character_classes_when_closed", "allowed_character_classes_when_closed")]
		public string m_allowed_character_classes_when_closed
		{
			get { return _m_allowed_character_classes_when_closed; }
			set { _m_allowed_character_classes_when_closed = value; this.Invalidate(); }
		}
