...
{
	[STNode("/")]
	public class VignetteSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "VignetteSettings";
			
			this.InputOptions.Add("vignette_factor", typeof(float), false);
			this.InputOptions.Add("vignette_chromatic_aberration_scale", typeof(float), false);
