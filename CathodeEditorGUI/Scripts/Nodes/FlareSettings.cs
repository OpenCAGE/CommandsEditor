...
{
	[STNode("/")]
	public class FlareSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "FlareSettings";
			
			this.InputOptions.Add("flareOffset0", typeof(float), false);
			this.InputOptions.Add("flareIntensity0", typeof(float), false);
			this.InputOptions.Add("flareAttenuation0", typeof(float), false);
			this.InputOptions.Add("flareOffset1", typeof(float), false);
			this.InputOptions.Add("flareIntensity1", typeof(float), false);
			this.InputOptions.Add("flareAttenuation1", typeof(float), false);
			this.InputOptions.Add("flareOffset2", typeof(float), false);
			this.InputOptions.Add("flareIntensity2", typeof(float), false);
			this.InputOptions.Add("flareAttenuation2", typeof(float), false);
			this.InputOptions.Add("flareOffset3", typeof(float), false);
			this.InputOptions.Add("flareIntensity3", typeof(float), false);
			this.InputOptions.Add("flareAttenuation3", typeof(float), false);
