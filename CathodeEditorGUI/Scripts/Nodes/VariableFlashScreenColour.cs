...
{
	[STNode("/")]
	public class VariableFlashScreenColour : STNode
	{
		...
		private string _m_flash_layer_name;
		[STNodeProperty("flash_layer_name", "flash_layer_name")]
		public string m_flash_layer_name
		{
			get { return _m_flash_layer_name; }
			set { _m_flash_layer_name = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.Title = "VariableFlashScreenColour";
			
			this.InputOptions.Add("initial_colour", typeof(cVector3), false);
