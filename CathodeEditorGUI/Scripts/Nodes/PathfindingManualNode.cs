...
{
	[STNode("/")]
	public class PathfindingManualNode : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "PathfindingManualNode";
			
			this.InputOptions.Add("PlayAnimData", typeof(string), false);
			...
			this.OutputOptions.Add("started_animating", typeof(void), false);
			this.OutputOptions.Add("stopped_animating", typeof(void), false);
