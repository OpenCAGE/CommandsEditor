...
namespace CommandsEditor.Nodes
{
	...
	public class Raycast : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.InputOptions.Add("source_position", typeof(cTransform), false);
			...
			this.OutputOptions.Add("Obstructed", typeof(void), false);
			this.OutputOptions.Add("Unobstructed", typeof(void), false);
			this.OutputOptions.Add("OutOfRange", typeof(void), false);
			this.OutputOptions.Add("hit_object", typeof(STNode), false);
			this.OutputOptions.Add("hit_distance", typeof(float), false);
			this.OutputOptions.Add("hit_position", typeof(cTransform), false);
