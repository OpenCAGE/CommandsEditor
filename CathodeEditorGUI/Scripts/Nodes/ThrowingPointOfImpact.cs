...
{
	[STNode("/")]
	public class ThrowingPointOfImpact : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ThrowingPointOfImpact";
			...
			this.OutputOptions.Add("show_point_of_impact", typeof(void), false);
			this.OutputOptions.Add("hide_point_of_impact", typeof(void), false);
			this.OutputOptions.Add("Location", typeof(cTransform), false);
			this.OutputOptions.Add("Visible", typeof(bool), false);
