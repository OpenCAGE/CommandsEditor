...
{
	[STNode("/")]
	public class PathfindingWaitNode : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "PathfindingWaitNode";
			...
			this.OutputOptions.Add("character_getting_near", typeof(void), false);
			this.OutputOptions.Add("character_arriving", typeof(void), false);
			this.OutputOptions.Add("character_stopped", typeof(void), false);
			this.OutputOptions.Add("started_waiting", typeof(void), false);
			this.OutputOptions.Add("stopped_waiting", typeof(void), false);
