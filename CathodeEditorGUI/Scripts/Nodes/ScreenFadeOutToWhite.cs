...
{
	[STNode("/")]
	public class ScreenFadeOutToWhite : STNode
	{
		private float _m_fade_value;
		[STNodeProperty("fade_value", "fade_value")]
		public float m_fade_value
		{
			get { return _m_fade_value; }
			set { _m_fade_value = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ScreenFadeOutToWhite";
