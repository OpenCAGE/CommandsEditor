...
{
	[STNode("/")]
	public class ClipPlanesController : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ClipPlanesController";
			
			this.InputOptions.Add("near_plane", typeof(float), false);
			this.InputOptions.Add("far_plane", typeof(float), false);
			this.InputOptions.Add("update_near", typeof(bool), false);
			this.InputOptions.Add("update_far", typeof(bool), false);
