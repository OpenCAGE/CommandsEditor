...
{
	[STNode("/")]
	public class DistortionSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "DistortionSettings";
			
			this.InputOptions.Add("radial_distort_factor", typeof(float), false);
			this.InputOptions.Add("radial_distort_constraint", typeof(float), false);
			this.InputOptions.Add("radial_distort_scalar", typeof(float), false);
