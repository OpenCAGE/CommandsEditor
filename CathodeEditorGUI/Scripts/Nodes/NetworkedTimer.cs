...
{
	[STNode("/")]
	public class NetworkedTimer : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.OutputOptions.Add("on_second_changed", typeof(void), false);
			this.OutputOptions.Add("on_started_counting", typeof(void), false);
			this.OutputOptions.Add("on_finished_counting", typeof(void), false);
			this.OutputOptions.Add("time_elapsed", typeof(float), false);
			this.OutputOptions.Add("time_left", typeof(float), false);
			this.OutputOptions.Add("time_elapsed_sec", typeof(int), false);
			this.OutputOptions.Add("time_left_sec", typeof(int), false);
