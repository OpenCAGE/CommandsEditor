...
{
	[STNode("/")]
	public class HableToneMappingSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "HableToneMappingSettings";
			
			this.InputOptions.Add("shoulder_strength", typeof(float), false);
			this.InputOptions.Add("linear_strength", typeof(float), false);
			this.InputOptions.Add("linear_angle", typeof(float), false);
			this.InputOptions.Add("toe_strength", typeof(float), false);
			this.InputOptions.Add("toe_numerator", typeof(float), false);
			this.InputOptions.Add("toe_denominator", typeof(float), false);
			this.InputOptions.Add("linear_white_point", typeof(float), false);
