...
{
	[STNode("/")]
	public class CHR_KnockedOutMonitor : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "CHR_KnockedOutMonitor";
			
			this.InputOptions.Add("apply_start", typeof(void), false);
			this.InputOptions.Add("apply_stop", typeof(void), false);
			
			this.OutputOptions.Add("on_knocked_out", typeof(void), false);
			this.OutputOptions.Add("on_recovered", typeof(void), false);
