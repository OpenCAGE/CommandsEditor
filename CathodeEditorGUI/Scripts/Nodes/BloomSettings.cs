...
{
	[STNode("/")]
	public class BloomSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "BloomSettings";
			
			this.InputOptions.Add("frame_buffer_scale", typeof(float), false);
			this.InputOptions.Add("frame_buffer_offset", typeof(float), false);
			this.InputOptions.Add("bloom_scale", typeof(float), false);
			this.InputOptions.Add("bloom_gather_exponent", typeof(float), false);
			this.InputOptions.Add("bloom_gather_scale", typeof(float), false);
