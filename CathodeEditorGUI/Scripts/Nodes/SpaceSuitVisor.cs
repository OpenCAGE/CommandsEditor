...
{
	[STNode("/")]
	public class SpaceSuitVisor : STNode
	{
		private float _m_breath_level;
		[STNodeProperty("breath_level", "breath_level")]
		public float m_breath_level
		{
			get { return _m_breath_level; }
			set { _m_breath_level = value; this.Invalidate(); }
		}
