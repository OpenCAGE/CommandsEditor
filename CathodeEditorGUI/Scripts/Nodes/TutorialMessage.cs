...
{
	[STNode("/")]
	public class TutorialMessage : STNode
	{
		...
		private string _m_text_list;
		[STNodeProperty("text_list", "text_list")]
		public string m_text_list
		{
			get { return _m_text_list; }
			set { _m_text_list = value; this.Invalidate(); }
		}
		
		private bool _m_show_animation;
		[STNodeProperty("show_animation", "show_animation")]
		public bool m_show_animation
		{
			get { return _m_show_animation; }
			set { _m_show_animation = value; this.Invalidate(); }
		}
