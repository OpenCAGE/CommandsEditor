...
{
	[STNode("/")]
	public class MELEE_WEAPON : STNode
	{
		private float _m_normal_attack_damage;
		[STNodeProperty("normal_attack_damage", "normal_attack_damage")]
		public float m_normal_attack_damage
		{
			get { return _m_normal_attack_damage; }
			set { _m_normal_attack_damage = value; this.Invalidate(); }
		}
		
		private float _m_power_attack_damage;
		[STNodeProperty("power_attack_damage", "power_attack_damage")]
		public float m_power_attack_damage
		{
			get { return _m_power_attack_damage; }
			set { _m_power_attack_damage = value; this.Invalidate(); }
		}
		
		private cTransform _m_position_input;
		[STNodeProperty("position_input", "position_input")]
		public cTransform m_position_input
		{
			get { return _m_position_input; }
			set { _m_position_input = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.Title = "MELEE_WEAPON";
			
			this.InputOptions.Add("item_animated_model_and_collision", typeof(STNode), false);
			this.InputOptions.Add("impact_with_world", typeof(void), false);
			...
			this.OutputOptions.Add("impacted_with_world", typeof(void), false);
