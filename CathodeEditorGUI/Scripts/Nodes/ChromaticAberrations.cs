...
{
	[STNode("/")]
	public class ChromaticAberrations : STNode
	{
		private float _m_aberration_scalar;
		[STNodeProperty("aberration_scalar", "aberration_scalar")]
		public float m_aberration_scalar
		{
			get { return _m_aberration_scalar; }
			set { _m_aberration_scalar = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ChromaticAberrations";
