...
{
	[STNode("/")]
	public class TRAV_ContinuousLedge : STNode
	{
		...
		private string _m_Sidling;
		[STNodeProperty("Sidling", "Sidling")]
		public string m_Sidling
		{
			get { return _m_Sidling; }
			set { _m_Sidling = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.Title = "TRAV_ContinuousLedge";
