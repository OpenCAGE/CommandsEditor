...
{
	[STNode("/")]
	public class ProjectileMotionComplex : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ProjectileMotionComplex";
			
			this.InputOptions.Add("start_position", typeof(cTransform), false);
			this.InputOptions.Add("start_velocity", typeof(cVector3), false);
			this.InputOptions.Add("start_angular_velocity", typeof(cVector3), false);
			this.InputOptions.Add("flight_time_in_seconds", typeof(float), false);
			...
			this.OutputOptions.Add("current_position", typeof(cTransform), false);
			this.OutputOptions.Add("current_velocity", typeof(cVector3), false);
			this.OutputOptions.Add("current_angular_velocity", typeof(cVector3), false);
			this.OutputOptions.Add("current_flight_time_in_seconds", typeof(float), false);
