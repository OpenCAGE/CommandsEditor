...
{
	[STNode("/")]
	public class ChokePoint : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "ChokePoint";
			
			this.InputOptions.Add("enable_chokepoint", typeof(void), false);
			this.InputOptions.Add("disable_chokepoint", typeof(void), false);
			...
			this.OutputOptions.Add("on_enable_chokepoint", typeof(void), false);
			this.OutputOptions.Add("on_disable_chokepoint", typeof(void), false);
