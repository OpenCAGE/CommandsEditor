...
{
	[STNode("/")]
	public class CHR_RetreatMonitor : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "CHR_RetreatMonitor";
			
			this.InputOptions.Add("apply_start", typeof(void), false);
			this.InputOptions.Add("apply_stop", typeof(void), false);
			
			this.OutputOptions.Add("reached_retreat", typeof(void), false);
			this.OutputOptions.Add("started_retreating", typeof(void), false);
