...
{
	[STNode("/")]
	public class BlendLowResFrame : STNode
	{
		private float _m_blend_value;
		[STNodeProperty("blend_value", "blend_value")]
		public float m_blend_value
		{
			get { return _m_blend_value; }
			set { _m_blend_value = value; this.Invalidate(); }
		}
