...
{
	[STNode("/")]
	public class DayToneMappingSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "DayToneMappingSettings";
			
			this.InputOptions.Add("black_point", typeof(float), false);
			this.InputOptions.Add("cross_over_point", typeof(float), false);
			this.InputOptions.Add("white_point", typeof(float), false);
			this.InputOptions.Add("shoulder_strength", typeof(float), false);
			this.InputOptions.Add("toe_strength", typeof(float), false);
			this.InputOptions.Add("luminance_scale", typeof(float), false);
