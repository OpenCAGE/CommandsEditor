...
{
	[STNode("/")]
	public class TriggerViewCone : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.OutputOptions.Add("target_is_visible", typeof(void), false);
			this.OutputOptions.Add("no_target_visible", typeof(void), false);
			this.OutputOptions.Add("visible_target", typeof(STNode), false);
