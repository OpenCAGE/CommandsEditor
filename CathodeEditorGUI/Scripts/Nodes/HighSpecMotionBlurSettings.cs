...
{
	[STNode("/")]
	public class HighSpecMotionBlurSettings : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "HighSpecMotionBlurSettings";
			
			this.InputOptions.Add("contribution", typeof(float), false);
			this.InputOptions.Add("camera_velocity_scalar", typeof(float), false);
			this.InputOptions.Add("camera_velocity_min", typeof(float), false);
			this.InputOptions.Add("camera_velocity_max", typeof(float), false);
			this.InputOptions.Add("object_velocity_scalar", typeof(float), false);
			this.InputOptions.Add("object_velocity_min", typeof(float), false);
			this.InputOptions.Add("object_velocity_max", typeof(float), false);
			this.InputOptions.Add("blur_range", typeof(float), false);
