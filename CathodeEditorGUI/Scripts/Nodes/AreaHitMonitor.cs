...
{
	[STNode("/")]
	public class AreaHitMonitor : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.Title = "AreaHitMonitor";
			
			this.InputOptions.Add("SpherePos", typeof(cTransform), false);
			this.InputOptions.Add("SphereRadius", typeof(float), false);
			...
			this.OutputOptions.Add("on_flamer_hit", typeof(void), false);
			this.OutputOptions.Add("on_shotgun_hit", typeof(void), false);
			this.OutputOptions.Add("on_pistol_hit", typeof(void), false);
