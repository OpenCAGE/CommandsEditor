...
{
	[STNode("/")]
	public class PlayerLightProbe : STNode
	{
		...
		protected override void OnCreate()
		{
			...
			this.OutputOptions.Add("output", typeof(cVector3), false);
			this.OutputOptions.Add("light_level_for_ai", typeof(float), false);
			this.OutputOptions.Add("dark_threshold", typeof(float), false);
			this.OutputOptions.Add("fully_lit_threshold", typeof(float), false);
