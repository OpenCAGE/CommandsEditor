...
{
	[STNode("/")]
	public class AllPlayersReady : STNode
	{
		...
		private float _m_activation_delay;
		[STNodeProperty("activation_delay", "activation_delay")]
		public float m_activation_delay
		{
			get { return _m_activation_delay; }
			set { _m_activation_delay = value; this.Invalidate(); }
		}
		...
		protected override void OnCreate()
		{
			...
			this.OutputOptions.Add("on_all_players_ready", typeof(void), false);
