...
namespace AlienConfigEditor
{
    public partial class AlienConfigEditor : DockContent
    {
        ...
        public AlienConfigEditor()
        {
            ...
            BML ammoTypes = new BML(SharedData.pathToAI + "\\DATA\\ALIENCONFIGS\\ALIENCONFIGS.BML");
        ...
        private void classSelection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            _selectedConfig.Add(new BML(SharedData.pathToAI + "\\DATA\\ALIENCONFIGS\\" + classSelection.Text + ".BML"));
            while (true)
            {
                ...
                _selectedConfig.Add(new BML(SharedData.pathToAI + "\\DATA\\ALIENCONFIGS\\" + template + ".BML"));
            }
