...
namespace CommandsEditor
{
    public partial class CAGEAnimation_DeleteEvent : BaseWindow
    {
        ...
        public CAGEAnimation_DeleteEvent(CommandsEditor editor, List<string> event_tracks) : base(WindowClosesOn.COMMANDS_RELOAD | WindowClosesOn.NEW_CAGEANIM_EDITOR_OPENED | WindowClosesOn.NEW_COMPOSITE_SELECTION, editor)
        {
            InitializeComponent();
