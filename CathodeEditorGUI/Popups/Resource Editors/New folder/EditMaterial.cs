...
namespace CommandsEditor
{
    public partial class EditMaterial : BaseWindow
    {
        ...
        public EditMaterial(Materials.Material material = null) : base(WindowClosesOn.COMMANDS_RELOAD | WindowClosesOn.NEW_ENTITY_SELECTION | WindowClosesOn.NEW_COMPOSITE_SELECTION)
        {
            ...
            // Add column for material name
            materialList.Columns.Add("Material Name", 360);
            
            // Group materials by ubershader type
            var groupedMaterials = _sortedMaterials
                .Where(m => m.Shader != null)
                .GroupBy(m => m.Shader.Ubershader)
            ...
            foreach (var group in groupedMaterials)
            {
                ...
                foreach (var mat in group.OrderBy(m => m.Name))
                {
                    ...
                    item.Tag = mat; // Store the material object in the Tag
        ...
        private void materialList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // Populate all available samplers for this shader as tabs
            ...
            for (int i = 0; i < samplers.Count; i++)
            {
                ...
                int textureRefIndex = 255; // Default to "no texture"
                ...
                // Track the first sampler with a texture
                ...
                System.Windows.Controls.TextBlock tabHeader = new System.Windows.Controls.TextBlock
                {
                    Text = sampler,
                ...
                System.Windows.Controls.StackPanel tabContent = new System.Windows.Controls.StackPanel { Margin = new System.Windows.Thickness(10) };
                
                // Texture preview section
                System.Windows.Controls.TextBlock textureFileText = new System.Windows.Controls.TextBlock 
                { 
                ...
                System.Windows.Controls.ScrollViewer imageScrollViewer = new System.Windows.Controls.ScrollViewer
                {
                ...
                System.Windows.Controls.Button pickTextureButton = new System.Windows.Controls.Button
                {
                    ...
                    Tag = i // Store the sampler index in the button's Tag
                };
                pickTextureButton.Click += (s, args) => OnPickTexture();
                
                // Details section
                System.Windows.Controls.TextBlock detailsText = new System.Windows.Controls.TextBlock
                {
                    TextWrapping = System.Windows.TextWrapping.Wrap,
                    Margin = new System.Windows.Thickness(0, 10, 0, 0)
                };
            ...
            // Select the first sampler with a texture, or the first sampler if none have textures
        ...
        {
            // Tab selection is handled automatically by the tab content
        ...
        private void OnPickTexture()
        {
            ...
            // TODO: Implement texture picker UI
            // For now, this is a placeholder that shows a message
            System.Windows.MessageBox.Show(
                $"Texture picker for sampler '{samplerName}' will be implemented here.\n\n" +
                $"Current texture reference index: {(textureRefIndex == 255 ? "Not assigned" : textureRefIndex.ToString())}",
                "Pick Texture",
