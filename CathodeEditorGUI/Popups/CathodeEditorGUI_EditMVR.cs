...
namespace CathodeEditorGUI
{
    public partial class CathodeEditorGUI_EditMVR : Form
    {
        ...
        private void LoadMVR(int mvrIndex)
        {
            ...
            renderable.PopulateUI(Editor.resource.reds.Entries[(int)mvr.renderableElementIndex].ModelIndex, modelMaterialIndexes);
        ...
        private void SaveMVR()
        {
            ...
            for (int y = 0; y < renderable.SelectedMaterialIndexes.Count; y++)
            {
                ...
                newRed.ModelIndex = Editor.resource.models.GetWriteIndex(renderable.SelectedModel.Submeshes[y]);
