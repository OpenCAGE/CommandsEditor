...
namespace CathodeEditorGUI
{
    public partial class CathodeEditorGUI_AddOrEditLink : Form
    {
        ...
        public CathodeEditorGUI_AddOrEditLink(Composite flowgraph, Entity parentEntity)
        {
            InitializeComponent();
        ...
        public CathodeEditorGUI_AddOrEditLink(Composite flowgraph, Entity parentEntity, Entity childEntity, string parentParameter, string childParameter, bool isLinkingToChild, ShortGuid initialLinkID)
        {
            InitializeComponent();
